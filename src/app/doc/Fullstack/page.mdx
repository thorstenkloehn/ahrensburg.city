...
1. **Einführung in die Programmierung**: Lernen Sie, was Programmierung ist und warum sie wichtig ist. Verstehen Sie die Grundkonzepte wie Variablen, Datentypen, Operatoren, Kontrollstrukturen und Funktionen.Specktzettel: <Link href="/doc/ProgrammiergrundlagenSpickzettel">Link zu einer Ressource</Link>
