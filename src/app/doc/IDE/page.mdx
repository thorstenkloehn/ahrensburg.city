...
code --install-exension vscjava.vscode-java-pack
code --install-extension vmware.vscode-boot-dev-pack
code --install-extension  ms-vscode-remote.remote-ssh
code --install-extension  ms-vscode.remote-server
code --install-exension unifiedjs.vscode-mdx
code --install-extension xyc.vscode-mdx-preview
code --install-extension jasperhale.vscode-next-js-snippets
...
### Astro
Astro ist besonders geeignet für Websites, die auf modernen Webtechnologien basieren und eine hohe Performance erfordern. Es bietet serverseitiges Rendering und generiert statische Websites, was es zu einer guten Wahl für performante, SEO-freundliche Websites macht.
### Installation
#### Hugo Installieren
```bash
...
##### Astro erstellen
```bash
npm create astro@latest -- --template framework-react start
```
### Quellangabe
* Quelle: [Hugo](https://gohugo.io/)
* Quelle: [Next.js](https://nextjs.org/)
* Quelle: [Astro](https://astro.build/)
