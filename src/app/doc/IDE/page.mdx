...
code --install-extenstion eliostruyf.vscode-front-matter
...
### nextjs
Next.js ist ein React-Framework für die Entwicklung von Webanwendungen. Es ist besonders geeignet für die Entwicklung von statischen Webseiten, Blogs, Dokumentationen und Portfolios. Next.js ist besonders schnell und sicher, da es statische Webseiten generiert. Es ist auch sehr einfach zu bedienen, da es auf React basiert.

### Astro.build
Astro ist ein modernes Web-Framework für den Bau von statischen Webseiten. Es ist besonders geeignet für die Entwicklung von Blogs, Dokumentationen, Portfolios und anderen Webseiten, die hauptsächlich aus Text und Bildern bestehen. Astro ist besonders schnell und sicher, da es statische Webseiten generiert. Es ist auch sehr einfach zu bedienen, da es auf JavaScript basiert.


## Weitere Links
* <Link href="/doc/IDEArchiv">Weitere Archiv</Link>
