...
```
### Spring Cli Installieren
```bash

# 1. Laden Sie die neueste Spring Boot CLI-Distribution herunter
wget https://repo.maven.apache.org/maven2/org/springframework/boot/spring-boot-cli/3.2.5/spring-boot-cli-3.2.5-bin.tar.gz
# 2. Entpacken Sie das Archiv
tar -xvf spring-boot-cli-3.2.5-bin.tar.gz

# 3. Fügen Sie Spring Boot CLI zum PATH hinzu
echo 'export PATH=$PATH:~/spring-3.2.5/bin' >> ~/.bashrc
source ~/.bashrc
```
### Java Kid  Installieren
```bash
