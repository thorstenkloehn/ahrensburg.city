    ...
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Bestätigungslink zum Ändern der E-Mail-Adresse wurde gesendet. Bitte überprüfen Sie Ihre E-Mails.";
                return RedirectToPage();
            }

            StatusMessage = "Ihre E-Mail-Adresse wurde nicht geändert.";
            return RedirectToPage();
        }
