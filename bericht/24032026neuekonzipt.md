...
- **Bewertung:** Da das System aktuell als Zentralinstanz für `wissen-ahrensburg.de` betrieben wird, ist dies ein gewünschtes Verhalten. Für den Betrieb von komplett fremden Mandanten wäre jedoch eine Isolation der Benutzerdaten notwendig.
...
- **Subdomain-Matching:** Durch die Einführung des "Best-Match"-Algorithmus im `TenantService` werden Subdomains (z.B. `doc.wissen-ahrensburg.de`) jetzt immer korrekt vor den Hauptdomains erkannt.
